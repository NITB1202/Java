        					...
        					.addGroup(panelBorder2Layout.createParallelGroup(Alignment.LEADING)
        						...
        						.addGroup(panelBorder2Layout.createSequentialGroup()
        							...
        							.addGroup(panelBorder2Layout.createParallelGroup(Alignment.TRAILING)
        								.addComponent(txtTheLoai, GroupLayout.DEFAULT_SIZE, 172, Short.MAX_VALUE)
        								.addComponent(txtNXB, GroupLayout.DEFAULT_SIZE, 172, Short.MAX_VALUE)
        								.addComponent(txtTacGia, GroupLayout.DEFAULT_SIZE, 172, Short.MAX_VALUE)
        								.addComponent(cbSach, 0, 172, Short.MAX_VALUE)
        								.addComponent(txtSoLuong, GroupLayout.DEFAULT_SIZE, 172, Short.MAX_VALUE)
        								.addGroup(panelBorder2Layout.createSequentialGroup()
        									.addGroup(panelBorder2Layout.createParallelGroup(Alignment.TRAILING)
        										.addGroup(panelBorder2Layout.createSequentialGroup()
        											.addPreferredGap(ComponentPlacement.RELATED)
        									...
        									.addPreferredGap(ComponentPlacement.RELATED))
        								.addComponent(txtGia, GroupLayout.DEFAULT_SIZE, 172, Short.MAX_VALUE))))
        					.addGap(37))
        				.addGroup(panelBorder2Layout.createSequentialGroup()
        					.addGap(25)
