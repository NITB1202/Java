...
public class BookImport_Dialog extends JDialog {
	 ...
	 */
	 ...
	 private MyDesign.MyTable tab;
	  ...
	  public BookImport_Dialog(java.awt.Frame parent, boolean modal) throws SQLException, IOException, ClassNotFoundException {
	        super(parent, modal);
	        try {
	            this.pack();
	            initComponents();
	            ...
	            Logger.getLogger(BookImport_Dialog.class.getName()).log(Level.SEVERE, null, ex);
	    ...
	    public void addDefaultBook(MyDesign.MyTable tab) throws Exception{
	    	tab.setRowCount(0);
	        ArrayList<Book1> arr= bookBUS.getAllIncludeVersion();
	        for(int i=0;i<arr.size();i++){
	            Book1 acc=arr.get(i);
	            String name=acc.getTenSach();
	            Vector<String> au=acc.getAuthor();
	            String version=acc.getVersion();
	            int num=acc.getStoreNum();
	            
	            Object row[] = {i+1,name,au,version,num};
	            tab.addRow(row);
	        }
	    }
